...
export default function RiderAccountScreen() {
  ...
  const menuItems = [
    ...
    { icon: "🎟️", label: "Promotions & Wallet", onPress: () => {} },
    { icon: "⭐", label: "My Ratings", onPress: () => {} },
    { icon: "🔔", label: "Notifications", onPress: () => {} },
    { icon: "🛡️", label: "Safety", onPress: () => {} },
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileCard}>
          ...
          <View style={styles.profileInfo}>
            <Text style={styles.profileName}>{profile?.full_name ?? "Rider"}</Text>
...
const styles = StyleSheet.create({
  ...
  ratingLabel: { fontFamily: FONTS.interRegular, fontSize: 13, color: COLORS.textSecondary },
  editBtn: {
    backgroundColor: COLORS.surface2, borderRadius: BORDER_RADIUS.sm,
    paddingHorizontal: 14, paddingVertical: 6, borderWidth: 1, borderColor: COLORS.border,
  },
  editText: { fontFamily: FONTS.interMedium, fontSize: 13, color: COLORS.text },
  menu: {
  ...
  version: {
    ...
    fontSize: 12, color: COLORS.textMuted, marginBottom: 32, marginTop: 4,
  },
});
